        ...
        <div class="questionnaire-section" style="max-width: 900px; margin: 0 auto; padding: 20px;">
            ...
            <div class="question-group" style="margin-bottom: 40px; padding-bottom: 30px; border-bottom: 2px solid #eee;">
                ...
                <div class="form-group" style="margin-bottom: 25px;">
                    ...
                    <div class="radio-group" style="display: flex; flex-direction: column; gap: 10px;">
                        <label class="radio-label" style="display: flex; align-items: flex-start; cursor: pointer; padding: 8px; border-radius: 5px; transition: background-color 0.3s;">
                            <input type="radio" name="grade" value="A" required style="flex-shrink: 0; margin-right: 12px; margin-top: 2px;">
                            <span style="flex: 1; text-align: left; word-break: break-word;">A. 9年级</span>
                        </label>
                        <label class="radio-label" style="display: flex; align-items: flex-start; cursor: pointer; padding: 8px; border-radius: 5px; transition: background-color 0.3s;">
                            <input type="radio" name="grade" value="B" style="flex-shrink: 0; margin-right: 12px; margin-top: 2px;">
                            <span style="flex: 1; text-align: left; word-break: break-word;">B. 10年级</span>
                        </label>
                        <label class="radio-label" style="display: flex; align-items: flex-start; cursor: pointer; padding: 8px; border-radius: 5px; transition: background-color 0.3s;">
                            <input type="radio" name="grade" value="C" style="flex-shrink: 0; margin-right: 12px; margin-top: 2px;">
                            <span style="flex: 1; text-align: left; word-break: break-word;">C. 11年级</span>
                        </label>
                        <label class="radio-label" style="display: flex; align-items: flex-start; cursor: pointer; padding: 8px; border-radius: 5px; transition: background-color 0.3s;">
                            <input type="radio" name="grade" value="D" style="flex-shrink: 0; margin-right: 12px; margin-top: 2px;">
                            <span style="flex: 1; text-align: left; word-break: break-word;">D. 12年级</span>
                        </label>
                    </div>
                </div>
                ...
                <div class="form-group" style="margin-bottom: 25px;">
                    ...
                    <div class="radio-group" style="display: flex; flex-direction: column; gap: 10px;">
                        <label class="radio-label" style="display: flex; align-items: flex-start; cursor: pointer; padding: 8px; border-radius: 5px; transition: background-color 0.3s;">
                            <input type="radio" name="education_system" value="A" required style="flex-shrink: 0; margin-right: 12px; margin-top: 2px;">
                            <span style="flex: 1; text-align: left; word-break: break-word;">A. 国际体系</span>
                        </label>
                        <label class="radio-label" style="display: flex; align-items: flex-start; cursor: pointer; padding: 8px; border-radius: 5px; transition: background-color 0.3s;">
                            <input type="radio" name="education_system" value="B" style="flex-shrink: 0; margin-right: 12px; margin-top: 2px;">
                            <span style="flex: 1; text-align: left; word-break: break-word;">B. 普高体系</span>
                        </label>
                    </div>
                </div>
                ...
                <div class="form-group" style="margin-bottom: 25px;">
                    ...
                    <div class="radio-group" style="display: flex; flex-direction: column; gap: 10px;">
                        <label class="radio-label" style="display: flex; align-items: flex-start; cursor: pointer; padding: 8px; border-radius: 5px; transition: background-color 0.3s;">
                            <input type="radio" name="learning_frequency" value="A" required style="flex-shrink: 0; margin-right: 12px; margin-top: 2px;">
                            <span style="flex: 1; text-align: left; word-break: break-word;">A. 一周1次或更频繁</span>
                        </label>
                        <label class="radio-label" style="display: flex; align-items: flex-start; cursor: pointer; padding: 8px; border-radius: 5px; transition: background-color 0.3s;">
                            <input type="radio" name="learning_frequency" value="B" style="flex-shrink: 0; margin-right: 12px; margin-top: 2px;">
                            <span style="flex: 1; text-align: left; word-break: break-word;">B. 一个月1-3次</span>
                        </label>
                        <label class="radio-label" style="display: flex; align-items: flex-start; cursor: pointer; padding: 8px; border-radius: 5px; transition: background-color 0.3s;">
                            <input type="radio" name="learning_frequency" value="C" style="flex-shrink: 0; margin-right: 12px; margin-top: 2px;">
                            <span style="flex: 1; text-align: left; word-break: break-word;">C. 几个月1次</span>
                        </label>
                    </div>
                </div>
                ...
                <div class="form-group" style="margin-bottom: 25px;">
                    ...
                    <div class="radio-group" style="display: flex; flex-direction: column; gap: 10px;">
                        <label class="radio-label" style="display: flex; align-items: flex-start; cursor: pointer; padding: 8px; border-radius: 5px; transition: background-color 0.3s;">
                            <input type="radio" name="physics_question" value="A" required style="flex-shrink: 0; margin-right: 12px; margin-top: 2px;">
                            <span style="flex: 1; text-align: left; word-break: break-word;">A. 变为原来的n倍</span>
                        </label>
                        <label class="radio-label" style="display: flex; align-items: flex-start; cursor: pointer; padding: 8px; border-radius: 5px; transition: background-color 0.3s;">
                            <input type="radio" name="physics_question" value="B" style="flex-shrink: 0; margin-right: 12px; margin-top: 2px;">
                            <span style="flex: 1; text-align: left; word-break: break-word;">B. 变为原来的1/n</span>
                        </label>
                        <label class="radio-label" style="display: flex; align-items: flex-start; cursor: pointer; padding: 8px; border-radius: 5px; transition: background-color 0.3s;">
                            <input type="radio" name="physics_question" value="C" style="flex-shrink: 0; margin-right: 12px; margin-top: 2px;">
                            <span style="flex: 1; text-align: left; word-break: break-word;">C. 保持不变</span>
                        </label>
                        <label class="radio-label" style="display: flex; align-items: flex-start; cursor: pointer; padding: 8px; border-radius: 5px; transition: background-color 0.3s;">
                            <input type="radio" name="physics_question" value="D" style="flex-shrink: 0; margin-right: 12px; margin-top: 2px;">
                            <span style="flex: 1; text-align: left; word-break: break-word;">D. 无法确定，因为光的频率也改变了</span>
                        </label>
                    </div>
                </div>
                ...
                <div class="form-group" style="margin-bottom: 25px;">
                    ...
                    <div class="radio-group" style="display: flex; flex-direction: column; gap: 10px;">
                        <label class="radio-label" style="display: flex; align-items: flex-start; cursor: pointer; padding: 8px; border-radius: 5px; transition: background-color 0.3s;">
                            <input type="radio" name="chemistry_question" value="A" required style="flex-shrink: 0; margin-right: 12px; margin-top: 2px;">
                            <span style="flex: 1; text-align: left; word-break: break-word;">A. pH值显著下降</span>
                        </label>
                        <label class="radio-label" style="display: flex; align-items: flex-start; cursor: pointer; padding: 8px; border-radius: 5px; transition: background-color 0.3s;">
                            <input type="radio" name="chemistry_question" value="B" style="flex-shrink: 0; margin-right: 12px; margin-top: 2px;">
                            <span style="flex: 1; text-align: left; word-break: break-word;">B. 醋酸根离子浓度与氢离子浓度的比值增大</span>
                        </label>
                        <label class="radio-label" style="display: flex; align-items: flex-start; cursor: pointer; padding: 8px; border-radius: 5px; transition: background-color 0.3s;">
                            <input type="radio" name="chemistry_question" value="C" style="flex-shrink: 0; margin-right: 12px; margin-top: 2px;">
                            <span style="flex: 1; text-align: left; word-break: break-word;">C. 醋酸的电离度显著降低</span>
                        </label>
                        <label class="radio-label" style="display: flex; align-items: flex-start; cursor: pointer; padding: 8px; border-radius: 5px; transition: background-color 0.3s;">
                            <input type="radio" name="chemistry_question" value="D" style="flex-shrink: 0; margin-right: 12px; margin-top: 2px;">
                            <span style="flex: 1; text-align: left; word-break: break-word;">D. 水的离子积常数Kw增大</span>
                        </label>
                    </div>
                </div>
                ...
                <div class="form-group" style="margin-bottom: 25px;">
                    ...
                    <div class="radio-group" style="display: flex; flex-direction: column; gap: 10px;">
                        <label class="radio-label" style="display: flex; align-items: flex-start; cursor: pointer; padding: 8px; border-radius: 5px; transition: background-color 0.3s;">
                            <input type="radio" name="biology_question" value="A" required style="flex-shrink: 0; margin-right: 12px; margin-top: 2px;">
                            <span style="flex: 1; text-align: left; word-break: break-word;">A. 为了在夜间更有效地进行光反应。</span>
                        </label>
                        <label class="radio-label" style="display: flex; align-items: flex-start; cursor: pointer; padding: 8px; border-radius: 5px; transition: background-color 0.3s;">
                            <input type="radio" name="biology_question" value="B" style="flex-shrink: 0; margin-right: 12px; margin-top: 2px;">
                            <span style="flex: 1; text-align: left; word-break: break-word;">B. 为了在白天关闭气孔以减少水分散失，同时仍能获取CO₂。</span>
                        </label>
                        <label class="radio-label" style="display: flex; align-items: flex-start; cursor: pointer; padding: 8px; border-radius: 5px; transition: background-color 0.3s;">
                            <input type="radio" name="biology_question" value="C" style="flex-shrink: 0; margin-right: 12px; margin-top: 2px;">
                            <span style="flex: 1; text-align: left; word-break: break-word;">C. 因为夜间土壤中水分更多，有利于CO₂吸收。</span>
                        </label>
                        <label class="radio-label" style="display: flex; align-items: flex-start; cursor: pointer; padding: 8px; border-radius: 5px; transition: background-color 0.3s;">
                            <input type="radio" name="biology_question" value="D" style="flex-shrink: 0; margin-right: 12px; margin-top: 2px;">
                            <span style="flex: 1; text-align: left; word-break: break-word;">D. 因为夜间温度更低，CO₂溶解度更高。</span>
                        </label>
                    </div>
                </div>
                ...
                <div class="form-group" style="margin-bottom: 25px;">
                    ...
                    <div class="radio-group" style="display: flex; flex-direction: column; gap: 10px;">
                        <label class="radio-label" style="display: flex; align-items: flex-start; cursor: pointer; padding: 8px; border-radius: 5px; transition: background-color 0.3s;">
                            <input type="radio" name="astronomy_question" value="A" required style="flex-shrink: 0; margin-right: 12px; margin-top: 2px;">
                            <span style="flex: 1; text-align: left; word-break: break-word;">A. 行星的精确质量</span>
                        </label>
                        <label class="radio-label" style="display: flex; align-items: flex-start; cursor: pointer; padding: 8px; border-radius: 5px; transition: background-color 0.3s;">
                            <input type="radio" name="astronomy_question" value="B" style="flex-shrink: 0; margin-right: 12px; margin-top: 2px;">
                            <span style="flex: 1; text-align: left; word-break: break-word;">B. 行星轨道周期的最小质量（M sin i）</span>
                        </label>
                        <label class="radio-label" style="display: flex; align-items: flex-start; cursor: pointer; padding: 8px; border-radius: 5px; transition: background-color 0.3s;">
                            <input type="radio" name="astronomy_question" value="C" style="flex-shrink: 0; margin-right: 12px; margin-top: 2px;">
                            <span style="flex: 1; text-align: left; word-break: break-word;">C. 行星的半径</span>
                        </label>
                        <label class="radio-label" style="display: flex; align-items: flex-start; cursor: pointer; padding: 8px; border-radius: 5px; transition: background-color 0.3s;">
                            <input type="radio" name="astronomy_question" value="D" style="flex-shrink: 0; margin-right: 12px; margin-top: 2px;">
                            <span style="flex: 1; text-align: left; word-break: break-word;">D. 行星大气的成分</span>
                        </label>
                    </div>
                </div>
                ...
                <div class="form-group" style="margin-bottom: 25px;">
                    ...
                    <div class="radio-group" style="display: flex; flex-direction: column; gap: 10px;">
                        <label class="radio-label" style="display: flex; align-items: flex-start; cursor: pointer; padding: 8px; border-radius: 5px; transition: background-color 0.3s;">
                            <input type="radio" name="geology_question" value="A" required style="flex-shrink: 0; margin-right: 12px; margin-top: 2px;">
                            <span style="flex: 1; text-align: left; word-break: break-word;">A. 持续的海平面上升</span>
                        </label>
                        <label class="radio-label" style="display: flex; align-items: flex-start; cursor: pointer; padding: 8px; border-radius: 5px; transition: background-color 0.3s;">
                            <input type="radio" name="geology_question" value="B" style="flex-shrink: 0; margin-right: 12px; margin-top: 2px;">
                            <span style="flex: 1; text-align: left; word-break: break-word;">B. 一次海平面下降，随后又上升</span>
                        </label>
                        <label class="radio-label" style="display: flex; align-items: flex-start; cursor: pointer; padding: 8px; border-radius: 5px; transition: background-color 0.3s;">
                            <input type="radio" name="geology_question" value="C" style="flex-shrink: 0; margin-right: 12px; margin-top: 2px;">
                            <span style="flex: 1; text-align: left; word-break: break-word;">C. 一次海平面的上升，随后又下降（一个完整的海侵-海退旋回）</span>
                        </label>
                        <label class="radio-label" style="display: flex; align-items: flex-start; cursor: pointer; padding: 8px; border-radius: 5px; transition: background-color 0.3s;">
                            <input type="radio" name="geology_question" value="D" style="flex-shrink: 0; margin-right: 12px; margin-top: 2px;">
                            <span style="flex: 1; text-align: left; word-break: break-word;">D. 持续的构造抬升</span>
                        </label>
                    </div>
                </div>
            </div>
            ...
            <div class="question-group" style="margin-bottom: 40px;">
                ...
                <div class="form-group" style="margin-bottom: 25px;">
                    ...
                    <div class="radio-group" style="display: flex; flex-direction: column; gap: 10px;">
                        <label class="radio-label" style="display: flex; align-items: flex-start; cursor: pointer; padding: 8px; border-radius: 5px; transition: background-color 0.3s;">
                            <input type="radio" name="knowledge_structure" value="A" required style="flex-shrink: 0; margin-right: 12px; margin-top: 2px;">
                            <span style="flex: 1; text-align: left; word-break: break-word;">A. 一本厚重的教科书，由浅入深</span>
                        </label>
                        <label class="radio-label" style="display: flex; align-items: flex-start; cursor: pointer; padding: 8px; border-radius: 5px; transition: background-color 0.3s;">
                            <input type="radio" name="knowledge_structure" value="B" style="flex-shrink: 0; margin-right: 12px; margin-top: 2px;">
                            <span style="flex: 1; text-align: left; word-break: break-word;">B. 一个完整的蜘蛛网，互相联系，互相支撑</span>
                        </label>
                        <label class="radio-label" style="display: flex; align-items: flex-start; cursor: pointer; padding: 8px; border-radius: 5px; transition: background-color 0.3s;">
                            <input type="radio" name="knowledge_structure" value="C" style="flex-shrink: 0; margin-right: 12px; margin-top: 2px;">
                            <span style="flex: 1; text-align: left; word-break: break-word;">C. 独立的数据库，每个学科都是独一无二的存储</span>
                        </label>
                        <label class="radio-label" style="display: flex; align-items: flex-start; cursor: pointer; padding: 8px; border-radius: 5px; transition: background-color 0.3s;">
                            <input type="radio" name="knowledge_structure" value="D" style="flex-shrink: 0; margin-right: 12px; margin-top: 2px;">
                            <span style="flex: 1; text-align: left; word-break: break-word;">D. 一个全能但是无序的工具箱</span>
                        </label>
                    </div>
                </div>
                ...
                <div class="form-group" style="margin-bottom: 25px;">
                    ...
                    <div class="checkbox-group" style="display: flex; flex-direction: column; gap: 10px; margin: 10px 0;">
                        <label class="checkbox-label" style="display: flex; align-items: flex-start; cursor: pointer; padding: 8px; border-radius: 5px; transition: background-color 0.3s;">
                            <input type="checkbox" name="evaluation_criteria" value="A" style="flex-shrink: 0; margin-right: 12px; margin-top: 2px;">
                            <span style="flex: 1; text-align: left; word-break: break-word;">A. 选段对现象描述的学术语言使用</span>
                        </label>
                        <label class="checkbox-label" style="display: flex; align-items: flex-start; cursor: pointer; padding: 8px; border-radius: 5px; transition: background-color 0.3s;">
                            <input type="checkbox" name="evaluation_criteria" value="B" style="flex-shrink: 0; margin-right: 12px; margin-top: 2px;">
                            <span style="flex: 1; text-align: left; word-break: break-word;">B. 选段中提及的分析问题、测量用到的科学技术</span>
                        </label>
                        <label class="checkbox-label" style="display: flex; align-items: flex-start; cursor: pointer; padding: 8px; border-radius: 5px; transition: background-color 0.3s;">
                            <input type="checkbox" name="evaluation_criteria" value="C" style="flex-shrink: 0; margin-right: 12px; margin-top: 2px;">
                            <span style="flex: 1; text-align: left; word-break: break-word;">C. 选段中提及的实验数据</span>
                        </label>
                        <label class="checkbox-label" style="display: flex; align-items: flex-start; cursor: pointer; padding: 8px; border-radius: 5px; transition: background-color 0.3s;">
                            <input type="checkbox" name="evaluation_criteria" value="D" style="flex-shrink: 0; margin-right: 12px; margin-top: 2px;">
                            <span style="flex: 1; text-align: left; word-break: break-word;">D. 选段中涉及的科学理论（现象和本质）</span>
                        </label>
                        <label class="checkbox-label" style="display: flex; align-items: flex-start; cursor: pointer; padding: 8px; border-radius: 5px; transition: background-color 0.3s;">
                            <input type="checkbox" name="evaluation_criteria" value="E" style="flex-shrink: 0; margin-right: 12px; margin-top: 2px;">
                            <span style="flex: 1; text-align: left; word-break: break-word;">E. 单纯凭感觉评分</span>
                        </label>
                    </div>
                </div>
                ...
                <div class="form-group" style="margin-bottom: 25px;">
                    ...
                    <div class="radio-group" style="display: flex; flex-direction: column; gap: 10px;">
                        <label class="radio-label" style="display: flex; align-items: flex-start; cursor: pointer; padding: 8px; border-radius: 5px; transition: background-color 0.3s;">
                            <input type="radio" name="climate_question" value="A" required style="flex-shrink: 0; margin-right: 12px; margin-top: 2px;">
                            <span style="flex: 1; text-align: left; word-break: break-word;">A. 全球变暖能直接导致或者间接导致什么后果？</span>
                        </label>
                        <label class="radio-label" style="display: flex; align-items: flex-start; cursor: pointer; padding: 8px; border-radius: 5px; transition: background-color 0.3s;">
                            <input type="radio" name="climate_question" value="B" style="flex-shrink: 0; margin-right: 12px; margin-top: 2px;">
                            <span style="flex: 1; text-align: left; word-break: break-word;">B. 温室效应是什么？什么是温室气体？它是怎么导致全球变暖的？</span>
                        </label>
                        <label class="radio-label" style="display: flex; align-items: flex-start; cursor: pointer; padding: 8px; border-radius: 5px; transition: background-color 0.3s;">
                            <input type="radio" name="climate_question" value="C" style="flex-shrink: 0; margin-right: 12px; margin-top: 2px;">
                            <span style="flex: 1; text-align: left; word-break: break-word;">C. 有什么相关技术可以改善温室效应？我们可以做什么去改善温室效应？</span>
                        </label>
                        <label class="radio-label" style="display: flex; align-items: flex-start; cursor: pointer; padding: 8px; border-radius: 5px; transition: background-color 0.3s;">
                            <input type="radio" name="climate_question" value="D" style="flex-shrink: 0; margin-right: 12px; margin-top: 2px;">
                            <span style="flex: 1; text-align: left; word-break: break-word;">D. 温室效应背后的学科领域是什么？哪些学科可以帮助理解或是改善温室效应？</span>
                        </label>
                        <label class="radio-label" style="display: flex; align-items: flex-start; cursor: pointer; padding: 8px; border-radius: 5px; transition: background-color 0.3s;">
                            <input type="radio" name="climate_question" value="E" style="flex-shrink: 0; margin-right: 12px; margin-top: 2px;">
                            <span style="flex: 1; text-align: left; word-break: break-word;">E. 除了温室效应，还有什么会导致全球变暖？</span>
                        </label>
                    </div>
                </div>
            </div>
